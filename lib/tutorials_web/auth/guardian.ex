defmodule TutorialsWeb.Auth.Guardian do
  # Guardian.DB works by hooking into the lifecycle of our Guardian module
  use Guardian, otp_app: :tutorials
  ...
  def authenticate(token) do
    with {:ok, claims} <- decode_and_verify(token),
         ...
         {:ok, _old_token, {new_token, _new_claims}} <- refresh(token) do

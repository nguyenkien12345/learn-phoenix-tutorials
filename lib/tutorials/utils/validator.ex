defmodule Tutorials.Utils.Validator do
  alias Ecto.Changeset

  alias Tutorials.Utils.{Error}

  @type type_validate :: [
    type: atom() | {:array, atom()} | {:array, map()}, # The data type of the field needs validation. It can be an atom or a tuple
    acceptance: [], # A list of accepted values
    change: (atom(), term() -> [{atom(), String.t()} | {atom(), {String.t(), Keyword.t()}}]), # A function is called to validate the field value. It is a function that takes an atom and a mutating function
    confirmation: [] | [{:required, boolean()}],
    exclusion: Enum.t(), # A list of unacceptable values
    format: Regex.t(), # A regular expression to validate the format of the value
    inclusion: Enum.t(), # A list of accepted values
    ...
    required: boolean(),
    subset: Enum.t() # The field's value must be part of the defined Enum list.
  ]
  ...
  def parse(%{} = _types, params, _opts) when is_nil(params) do
